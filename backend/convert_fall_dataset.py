"""
将跌倒检测数据集从 VOC XML 格式转换为 YOLO 格式
源路径: C:\\Users\\23184\\Desktop\\行人跌倒检测
类别: 0: fall (跌倒)
"""
import os
...
# 源数据路径
SRC_DIR = r"C:\Users\23184\Desktop\行人跌倒检测"
SRC_IMAGES = os.path.join(SRC_DIR, "images")
SRC_ANNOTATIONS = os.path.join(SRC_DIR, "Annotations")

# 目标 YOLO 数据集路径
DST_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "data", "fall_yolo")
